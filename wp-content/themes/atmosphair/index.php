...
<main class="layout">
    <div class="main__header">
        <h2 class="main__title fade-in"><?= __('Pour un air plus','atmosph\'air') . "<br>" . __('sain au coeur de la ville !','atmosph\'air'); ?></h2>
    </div>
    ...
    <section class="main__presentation">
        <h3 class="presentation__title fade-in"><?= __('L’air joue un rôle ', 'atmosh\'air') .  '<em>' . __('primordial ', 'atmosh\'air') . '</em>' . __('pour la vie telle que nous la connaissons sur terre.','atmosph\'air'); ?></h3>
    ...
    <section class="main__actors fade-in">
