<?= get_header(); ?>
    <main class="singleMain" itemscope itemtype="https://schema.org/Project" aria-labelledby="singleTitle<?= get_the_title(); ?>">
        ...
        <div class="main__title fade-in" style="background-image: url(<?= get_the_post_thumbnail_url(null, 'medium', ['class' => 'actor__thumb']); ?>">
        ...
        <article class="main__promotion" aria-labelledby="promotion<?= get_the_title(); ?>">
            ...
            <img class="promotion__image fade-in" src="./src/images/hepl.jpg" alt="Bâtiment de la HEPL">
