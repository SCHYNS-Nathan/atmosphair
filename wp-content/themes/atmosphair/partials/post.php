<article class="post post--<?= $modifier; ?>">
    <a href="<?= get_the_permalink(); ?>" class="post__link"><?= str_replace(':title', get_the_title(), __('Lire l\'article ":title"', 'atmosphair')); ?></a>
    <div class="post__card">
        <header class="post__head">
            ...
            <p class="post__meta"><?= str_replace(
                ...
                __('Publié par :author le :date', 'atmosphair')); ?></p>
        </header>
